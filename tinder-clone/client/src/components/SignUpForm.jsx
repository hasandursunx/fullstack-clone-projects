            ...
            <div>
                ...
                <div className="mt-2 flex gap-2">
                    <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="male" className="ml-2 block text-sm">
                            Male
                        </label>
                    </div>
                    <div className="flex items-center">
                        <input
                            ...
                            className="h-4 w-4 text-pink-600 focus:ring-pink-500 border-gray-300 rounded"
                        />
                        <label htmlFor="female" className="ml-2 block text-sm">
                            Female
                        </label>
                    </div>
                </div>
                ...
                <div className="mt-2 space-y-2">
                    <div className="flex items-center">
                        <input
                            ...
                            className="h-4 w-4 text-ping-600 focus:ring-pink-500 border-gray-300"
                        />
